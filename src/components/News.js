    ...
    render() {
        return (
            <div className="container">
                <h2 className="text-center my-5">React News App - {this.props.category.toUpperCase()}</h2>
